          ...
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="space-y-8 sm:space-y-12">
              {[
                {
                  year: "01",
                  role: "Rebook Command Center",
                  company: "Paradigm.ai",
                  description: "Turn rows into outreach. Enrich cols 11–16; generate SMS + timing windows; Confidence score; Next_Action. Sort ≥80, send or call VIP.",
                  tech: ["Paradigm", "SMS", "Risk"],
                },
                {
                  year: "02",
                  role: "Owner-Analyst Agent",
                  company: "Weekly one-pager + ask-me-anything",
                  description: "\"What changed vs prior 4?\" KPIs: Revenue, Show Rate, Rebook Conversion, LTV Mix, Provider Capacity.",
                  tech: ["KPIs", "Trends"],
                },
                {
                  year: "03",
                  role: "Inventory Agent",
                  company: "Fewer stockouts, better bundles",
                  description: "Forecast 4 weeks; flag <14-day stockouts; suggest service→product bundles.",
                  tech: ["Retail", "Forecast"],
                },
                {
                  year: "04",
                  role: "Campaign Agent",
                  company: "Lapsed-client nudges with guardrails",
                  description: "Quiet hours (20:30–08:00), throttle, opt-outs, approval before send.",
                  tech: ["Segments", "Safety"],
                },
              ].map((job, index) => (
                <div
                  key={index}
          ...
          <div className="space-y-12 sm:space-y-16">
            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                {
                  title: "Prompt Pack",
                  excerpt: "Plug-and-play prompts for copy, sheets, and SMS.",
                  url: "/prompt-pack",
                },
                {
                  title: "Model Picker",
                  excerpt: "When to use ChatGPT/Claude/Gemini.",
                  url: "#models",
                },
                {
                  title: "Safety & Governance",
                  excerpt: "Quiet hours, logs, approvals.",
                  url: "/security",
                },
                {
                  title: "Live Demo",
                  excerpt: "Enrich 30 rows; read 2 texts aloud.",
                  url: "/demo",
                },
              ].map((card, index) => (
                <Link
